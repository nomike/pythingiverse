...
class CategoriesSlugGet200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "url", "count", "things_url", "thumbnail", "preview_image", "children"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children": [CategorySchema.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj
