...
class CategoriesReturnCompleteGet200ResponseInner(BaseModel):
    """
    CategoriesReturnCompleteGet200ResponseInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    children: Optional[List[CategoriesGet200ResponseInner]] = None
    __properties: ClassVar[List[str]] = ["name", "url", "children"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "url": obj.get("url"),
            "children": [CategoriesGet200ResponseInner.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj
