...
class Programs0AllGet200Response(BaseModel):
    """
    Programs0AllGet200Response
    """ # noqa: E501
    count: Optional[StrictInt] = None
    programs: Optional[List[ProgramSchema]] = None
    __properties: ClassVar[List[str]] = ["count", "programs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "programs": [ProgramSchema.from_dict(_item) for _item in obj["programs"]] if obj.get("programs") is not None else None
        })
        return _obj
