...
class EmailThingiverseEnqueueSupportPostRequest(BaseModel):
    """
    EmailThingiverseEnqueueSupportPostRequest
    """ # noqa: E501
    subject: StrictStr = Field(description="Email subject")
    text: StrictStr = Field(description="Email text")
    html: Optional[StrictStr] = Field(default=None, description="Email as HTML")
    __properties: ClassVar[List[str]] = ["subject", "text", "html"]
