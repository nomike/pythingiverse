...
class MessagesPost200Response(BaseModel):
    """
    MessagesPost200Response
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    is_read: Optional[Annotated[int, Field(le=1, strict=True, ge=0)]] = None
    subject: Optional[StrictStr] = None
    user: Optional[MessagesPost200ResponseUser] = None
    __properties: ClassVar[List[str]] = ["id", "is_read", "subject", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": MessagesPost200ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
