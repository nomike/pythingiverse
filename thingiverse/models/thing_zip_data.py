...
class ThingZipData(BaseModel):
    """
    ThingZipData
    """ # noqa: E501
    files: Optional[List[ThingZipDataFilesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "files": [ThingZipDataFilesInner.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None
        })
        return _obj
