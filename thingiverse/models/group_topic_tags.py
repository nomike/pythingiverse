...
class GroupTopicTags(BaseModel):
    """
    GroupTopicTags
    """ # noqa: E501
    name: Optional[StrictStr] = None
    url: Optional[UrlSchema] = None
    count: Optional[StrictInt] = None
    absolute_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "url", "count", "absolute_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "url": UrlSchema.from_dict(obj["url"]) if obj.get("url") is not None else None,
            "count": obj.get("count"),
