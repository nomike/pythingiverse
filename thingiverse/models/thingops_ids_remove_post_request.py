...
class ThingopsIdsRemovePostRequest(BaseModel):
    """
    ThingopsIdsRemovePostRequest
    """ # noqa: E501
    collection_id: StrictInt = Field(description="Set the id of the collection from which the specified thing will be removed")
