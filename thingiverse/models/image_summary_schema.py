...
class ImageSummarySchema(BaseModel):
    ...
    sizes: Optional[List[ImageSummarySizesInner]] = None
    added: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "url", "name", "sizes", "added"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "name": obj.get("name"),
            "sizes": [ImageSummarySizesInner.from_dict(_item) for _item in obj["sizes"]] if obj.get("sizes") is not None else None,
            "added": obj.get("added")
        })
        return _obj
