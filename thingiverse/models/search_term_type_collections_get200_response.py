...
class SearchTermTypeCollectionsGet200Response(BaseModel):
    """
    SearchTermTypeCollectionsGet200Response
    """ # noqa: E501
    total: Optional[StrictInt] = None
    hits: Optional[List[CollectionSchema]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "hits": [CollectionSchema.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None
        })
        return _obj
