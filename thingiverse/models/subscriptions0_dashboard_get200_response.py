...
class Subscriptions0DashboardGet200Response(BaseModel):
    """
    Subscriptions0DashboardGet200Response
    """ # noqa: E501
    items: Optional[List[Subscriptions0DashboardGet200ResponseItemsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Subscriptions0DashboardGet200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "count": obj.get("count")
        })
        return _obj
