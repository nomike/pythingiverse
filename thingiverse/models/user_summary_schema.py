...
class UserSummarySchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "first_name", "last_name", "url", "public_url", "thumbnail", "count_of_followers", "count_of_following", "count_of_designs", "collection_count", "make_count", "accepts_tips", "is_following", "location", "cover", "is_admin"]
