...
class SitewidenotificationSchema(BaseModel):
    """
    SitewidenotificationSchema
    """ # noqa: E501
    id: Optional[StrictInt] = None
    notification: Optional[StrictStr] = None
    notification_html: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "notification", "notification_html", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notification_html": obj.get("notification_html"),
            "type": obj.get("type")
        })
        return _obj
