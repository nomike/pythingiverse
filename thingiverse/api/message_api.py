...
class MessageApi:
    ...
    def messages_post(
        self,
        messages_post_request: Optional[MessagesPostRequest] = None,
        ...
        :param messages_post_request:
        :type messages_post_request: MessagesPostRequest
    ...
    def messages_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MessagesPost200Response]:
        """Create a new message to share a thing
    ...
    def _messages_post_serialize(
        ...
        if messages_post_request is not None:
            _body_params = messages_post_request
