...
class FileApi:
    ...
    def files0_upload_file_post(
        ...
        _param = self._files0_upload_file_post_serialize(
            file=file,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Files0UploadFilePost200Response",
    ...
    @validate_call
    def files0_upload_file_post_with_http_info(
        self,
        file: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Files0UploadFilePost200Response]:
        """Upload a file as pendingupload
    ...
    @validate_call
    def files0_upload_file_post_without_preload_content(
        self,
        file: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = None,
        _request_timeout: Union[
            None,
    ...
    def _files0_upload_file_post_serialize(
        self,
        file,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/files/0/uploadFile',
    ...
    @validate_call
    def files_file_id_download_get(
        self,
        ...
        _param = self._files_file_id_download_get_serialize(
            file_id=file_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def files_file_id_download_get_with_http_info(
        self,
        file_id: Annotated[int, Field(strict=True, ge=1, description="The id of the file")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def files_file_id_download_get_without_preload_content(
        self,
        file_id: Annotated[int, Field(strict=True, ge=1, description="The id of the file")],
        _request_timeout: Union[
            None,
    ...
    def _files_file_id_download_get_serialize(
        self,
        file_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/files/{file_id}/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def files_file_id_get(
        ...
        _param = self._files_file_id_get_serialize(
            file_id=file_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def files_file_id_get_with_http_info(
        self,
        file_id: Annotated[int, Field(strict=True, ge=1, description="The id of the file")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def files_file_id_get_without_preload_content(
        self,
        file_id: Annotated[int, Field(strict=True, ge=1, description="The id of the file")],
        _request_timeout: Union[
            None,
    ...
    def _files_file_id_get_serialize(
        self,
        file_id,
        _request_auth,
        _content_type,
