...
class ChangelogApi:
    ...
    def changelogs_get(
        ...
        _param = self._changelogs_get_serialize(
    ...
    @validate_call
    def changelogs_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ChangelogSchema]]:
        """Get changelogs
    ...
    @validate_call
    def changelogs_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
