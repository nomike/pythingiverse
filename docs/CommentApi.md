...
with thingiverse.ApiClient(configuration) as api_client:
    ...
    api_instance = thingiverse.CommentApi(api_client)
    comments0_markdown_post_request = thingiverse.Comments0MarkdownPostRequest() # Comments0MarkdownPostRequest |  (optional)
...
with thingiverse.ApiClient(configuration) as api_client:
    ...
    api_instance = thingiverse.CommentApi(api_client)
    comment_id = 285620 # int | The id of the comment
    comment_schema = thingiverse.CommentSchema() # CommentSchema |  (optional)
...
with thingiverse.ApiClient(configuration) as api_client:
    ...
    api_instance = thingiverse.CommentApi(api_client)
    comment_id = 285620 # int | The id of the comment
    comments_post_request = thingiverse.CommentsPostRequest() # CommentsPostRequest |  (optional)
