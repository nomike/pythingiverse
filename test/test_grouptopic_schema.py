...
class TestGrouptopicSchema(unittest.TestCase):
    """GrouptopicSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrouptopicSchema:
        """Test GrouptopicSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrouptopicSchema`
        """
        model = GrouptopicSchema()
        if include_optional:
            return GrouptopicSchema(
                id = 56,
                name = '',
                user = thingiverse.models.member_schema.member_schema(
                    id = 56, 
                    name = '', 
                    first_name = '', 
                    last_name = '', 
