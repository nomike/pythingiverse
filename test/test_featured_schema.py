...
class TestFeaturedSchema(unittest.TestCase):
    """FeaturedSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeaturedSchema:
        """Test FeaturedSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeaturedSchema`
        """
        model = FeaturedSchema()
        if include_optional:
            return FeaturedSchema(
                ...
                is_nsfw = True,
                rank = 56,
                spotlight_images = thingiverse.models.featured_spotlight_images.Featured_spotlight_images(
                    large = '', 
                    small = '', )
            )
        else:
