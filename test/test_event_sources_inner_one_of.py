...
class TestEventSourcesInnerOneOf(unittest.TestCase):
    """EventSourcesInnerOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventSourcesInnerOneOf:
        """Test EventSourcesInnerOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventSourcesInnerOneOf`
        """
        model = EventSourcesInnerOneOf()
        if include_optional:
            return EventSourcesInnerOneOf(
                thumbnail = '',
    ...
    def testEventSourcesInnerOneOf(self):
        """Test EventSourcesInnerOneOf"""
