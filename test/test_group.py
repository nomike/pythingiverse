    ...
    def make_instance(self, include_optional) -> Group:
        ...
        if include_optional:
            return Group(
                ...
                creator = 56,
                is_member = True,
                members = thingiverse.models.group_members.Group_members(
                    count = 56, 
                    url = '', ),
                things = thingiverse.models.group_members.Group_members(
                    count = 56, 
                    url = '', ),
                group_topics = thingiverse.models.group_members.Group_members(
                    count = 56, 
                    url = '', ),
                featured = [
                    thingiverse.models.group_featured_inner.Group_featured_inner(
                        id = 56, 
                        name = '', 
                        thumbnail = '', 
                        url = '', 
                ...
                featured_images = [
                    thingiverse.models.group_featured_images_inner.Group_featured_images_inner(
                        url_image = '', 
                        url_thing = '', )
                    ],
                pinned_topics = 56
