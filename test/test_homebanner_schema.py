...
class TestHomebannerSchema(unittest.TestCase):
    """HomebannerSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HomebannerSchema:
        """Test HomebannerSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HomebannerSchema`
        """
        model = HomebannerSchema()
        if include_optional:
            return HomebannerSchema(
                id = 56,
                title = '',
                body = '',
                type = '',
