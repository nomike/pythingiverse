...
class TestEventTargetsInner(unittest.TestCase):
    """EventTargetsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventTargetsInner:
        """Test EventTargetsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventTargetsInner`
        """
        model = EventTargetsInner()
        if include_optional:
            return EventTargetsInner(
                thumbnail = '',
                things_url = '',
    ...
    def testEventTargetsInner(self):
        """Test EventTargetsInner"""
