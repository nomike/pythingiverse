    ...
    def make_instance(self, include_optional) -> CopiesCopyIdThreadedCommentsGet200Response:
        ...
        if include_optional:
            return CopiesCopyIdThreadedCommentsGet200Response(
                comments = {
                    'key' : thingiverse.models._copies__copy_id__threaded_comments_get_200_response_comments_value._copies__copy_id__threaded_comments_get_200_response_comments_value(
                        id = 0, 
                ...
                users = {
                    'key' : thingiverse.models._copies__copy_id__threaded_comments_get_200_response_users_value._copies__copy_id__threaded_comments_get_200_response_users_value(
                        user_name = '', 
                        user_avatar = '', 
                        is_admin = 0, )
                    }
