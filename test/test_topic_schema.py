    ...
    def make_instance(self, include_optional) -> TopicSchema:
        ...
        if include_optional:
            return TopicSchema(
                ...
                comments = thingiverse.models.topic_schema_comments.topic_schema_comments(
                    count = 56, 
                    threaded_url = '', 
                    url = '', ),
                comment_of_topic = thingiverse.models.topic_schema_comment_of_topic.topic_schema_comment_of_topic(
                    id = 56, 
                    topic_name = '', 
                    body = '', 
                    body_html = '', 
