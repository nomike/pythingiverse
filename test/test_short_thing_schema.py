...
class TestShortThingSchema(unittest.TestCase):
    """ShortThingSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShortThingSchema:
        """Test ShortThingSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShortThingSchema`
        """
        model = ShortThingSchema()
        if include_optional:
            return ShortThingSchema(
                id = 56,
                name = '',
                url = '',
                public_url = '',
