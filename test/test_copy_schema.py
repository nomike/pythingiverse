...
class TestCopySchema(unittest.TestCase):
    """CopySchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CopySchema:
        """Test CopySchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CopySchema`
        """
        model = CopySchema()
        if include_optional:
            return CopySchema(
