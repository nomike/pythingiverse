...
class TestUserSummarySchema1(unittest.TestCase):
    """UserSummarySchema1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserSummarySchema1:
        """Test UserSummarySchema1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserSummarySchema1`
        """
        model = UserSummarySchema1()
        if include_optional:
            return UserSummarySchema1(
                id = 1336,
                name = 'CreativeTools',
                first_name = 'Creative',
                last_name = 'Tools',
    ...
    def testUserSummarySchema1(self):
        """Test UserSummarySchema1"""
