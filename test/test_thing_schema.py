...
class TestThingSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ThingSchema:
        """Test ThingSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThingSchema`
        """
        model = ThingSchema()
        if include_optional:
            return ThingSchema(
