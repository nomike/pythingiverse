...
class TestHomeBanner(unittest.TestCase):
    """HomeBanner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HomeBanner:
        """Test HomeBanner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HomeBanner`
        """
        model = HomeBanner()
        if include_optional:
            return HomeBanner(
