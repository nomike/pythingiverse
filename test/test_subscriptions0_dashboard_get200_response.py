...
class TestSubscriptions0DashboardGet200Response(unittest.TestCase):
    """Subscriptions0DashboardGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Subscriptions0DashboardGet200Response:
        """Test Subscriptions0DashboardGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Subscriptions0DashboardGet200Response`
        """
        model = Subscriptions0DashboardGet200Response()
        if include_optional:
            return Subscriptions0DashboardGet200Response(
                items = [
                    thingiverse.models._subscriptions_0_dashboard_get_200_response_items_inner._subscriptions_0_dashboard_get_200_response_items_inner(
                        message = '', 
    ...
    def testSubscriptions0DashboardGet200Response(self):
        """Test Subscriptions0DashboardGet200Response"""
